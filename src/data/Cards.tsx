...
const sortByTitle = (list: Contents[]) =>
...
sortByTitle(defaultBackstories);
...
export const defaultSpells: Contents[] = [
  ...
  // Additional spells added for expanded catalog.  Each includes full
  // metadata in headerBlock and a succinct description.  See citations for
  // mechanical details.
  {
    title: "Cure Wounds",
    headerBlock:
